...
class Container {
    ...
    protected function registerCoreServices() {
        ...
        $this->services['config'] = function() {
            return new \PHPFrame\ConfigManager([
                'app' => require CONFIG_PATH . '/app.php',
                'database' => require CONFIG_PATH . '/database.php',
                'cache' => require CONFIG_PATH . '/cache.php',
                'storage' => require CONFIG_PATH . '/storage.php',
                'notify' => require CONFIG_PATH . '/notify.php',
                'exception' => require CONFIG_PATH . '/exception.php',
            ]);
        };
        ...
        $this->services['router'] = function() {
            return \FastRoute\simpleDispatcher(function(\FastRoute\RouteCollector $r) {
                ...
                \PHPFrame\Facades\Route::setCollector($r);
        ...
        $this->services['db'] = function($c) {
            ...
            $dbManager = new \PHPFrame\Database\DatabaseManager($capsule);
        ...
        $this->services['cache'] = function($c) {
            ...
            return new \PHPFrame\CacheManager($repository);
        };
        
        // 日志服务
        $this->services['logger'] = function() {
            $logConfig = require CONFIG_PATH . '/log.php';
            return \PHPFrame\Logger::getInstance($logConfig);
        };
        ...
        $this->services['PHPFrame\Database\DatabaseManager'] = function($c) {
            ...
            return new \PHPFrame\Database\DatabaseManager($capsule);
        };
